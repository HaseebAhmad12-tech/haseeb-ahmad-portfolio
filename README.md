...
## V3.0 polish
- Fixed scrollbar-drag white flash/repaint issue.
- Consolidated animated skills into one unique set and added HTML, CSS and Bootstrap.
- Added GitHub/LinkedIn icons above hero CTAs and changed primary CTA to Contact me.
- Modernized and compacted Experience, Projects, Certifications and Blog cards.
- Corrected blog carousel widths so the third/last visible card is not clipped.
